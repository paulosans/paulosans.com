    ...
    <>
      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <div className="px-6 sm:px-12 lg:px-[200px] mt-16 lg:mt-[80px]">
          ...
          <h1 style={{ fontFamily: "'Agrandir'", fontWeight: 800, fontSize: "clamp(56px, 9vw, 140px)", color: "#242a2f", lineHeight: 0.9, letterSpacing: "-2px" }}>
            Warren
          </h1>
          ...
          <div
            ...
            style={{ height: 480, background: `${BRAND_COLOR}12` }}
          >
            <p style={{ fontFamily: "'Agrandir'", fontWeight: 800, fontSize: 22, color: BRAND_COLOR, letterSpacing: "0.5px" }}>
              Em breve
            </p>
          </div>
